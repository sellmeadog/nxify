...
export type PageCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  modules?: InputMaybe<PageModulesCreateOneInlineInput>;
...
export type PageManyWhereInput = {
  ...
  modules?: InputMaybe<PageModulesWhereInput>;
...
export type PageModules = Article;

export type PageModulesConnectInput = {
  Article?: InputMaybe<ArticleConnectInput>;
};

export type PageModulesCreateInput = {
  Article?: InputMaybe<ArticleCreateInput>;
};

export type PageModulesCreateManyInlineInput = {
  /** Connect multiple existing PageModules documents */
  connect?: InputMaybe<Array<PageModulesWhereUniqueInput>>;
  /** Create and connect multiple existing PageModules documents */
  create?: InputMaybe<Array<PageModulesCreateInput>>;
};

export type PageModulesCreateOneInlineInput = {
  /** Connect one existing PageModules document */
  connect?: InputMaybe<PageModulesWhereUniqueInput>;
  /** Create and connect one PageModules document */
  create?: InputMaybe<PageModulesCreateInput>;
};

export type PageModulesUpdateInput = {
  Article?: InputMaybe<ArticleUpdateInput>;
};

export type PageModulesUpdateManyInlineInput = {
  /** Connect multiple existing PageModules documents */
  connect?: InputMaybe<Array<PageModulesConnectInput>>;
  /** Create and connect multiple PageModules documents */
  create?: InputMaybe<Array<PageModulesCreateInput>>;
  /** Delete multiple PageModules documents */
  delete?: InputMaybe<Array<PageModulesWhereUniqueInput>>;
  /** Disconnect multiple PageModules documents */
  disconnect?: InputMaybe<Array<PageModulesWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing PageModules documents */
  set?: InputMaybe<Array<PageModulesWhereUniqueInput>>;
  /** Update multiple PageModules documents */
  update?: InputMaybe<Array<PageModulesUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple PageModules documents */
  upsert?: InputMaybe<Array<PageModulesUpsertWithNestedWhereUniqueInput>>;
};

export type PageModulesUpdateManyWithNestedWhereInput = {
  Article?: InputMaybe<ArticleUpdateManyWithNestedWhereInput>;
};

export type PageModulesUpdateOneInlineInput = {
  /** Connect existing PageModules document */
  connect?: InputMaybe<PageModulesWhereUniqueInput>;
  /** Create and connect one PageModules document */
  create?: InputMaybe<PageModulesCreateInput>;
  /** Delete currently connected PageModules document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Disconnect currently connected PageModules document */
  disconnect?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single PageModules document */
  update?: InputMaybe<PageModulesUpdateWithNestedWhereUniqueInput>;
  /** Upsert single PageModules document */
  upsert?: InputMaybe<PageModulesUpsertWithNestedWhereUniqueInput>;
};

export type PageModulesUpdateWithNestedWhereUniqueInput = {
  Article?: InputMaybe<ArticleUpdateWithNestedWhereUniqueInput>;
};

export type PageModulesUpsertWithNestedWhereUniqueInput = {
  Article?: InputMaybe<ArticleUpsertWithNestedWhereUniqueInput>;
};

export type PageModulesWhereInput = {
  Article?: InputMaybe<ArticleWhereInput>;
};

export type PageModulesWhereUniqueInput = {
...
export type PageUpdateInput = {
  modules?: InputMaybe<PageModulesUpdateOneInlineInput>;
...
export type PagesectionsUnion = HomePageHero;
...
export const PageBySlugDocument = new TypedDocumentString(`
