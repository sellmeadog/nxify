...
export function ArticlePreview({ data }: ArticlePreviewProps) {
  ...
  return (
    <article className="prose-headings:font-light prose-headings:mt-0 prose-p:mb-0 border-neutral-800 last-of-type:border-transparent border-b py-8 first-of-type:pt-0 last-of-type:pb-0 lg:py-16">
      <header>
